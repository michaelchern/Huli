...
namespace Huli::Vulkan
{
    ...
    Pipeline::Pipeline(const Context* context, const ComputePipelineDescriptor& desc, const std::string& name /*= ""*/)
        : context_(context),
    ...
    void Pipeline::updatePushConstant(VkCommandBuffer commandBuffer,
    ...
    void Pipeline::allocateDescriptors(const std::vector<SetAndCount>& setAndCount)
    {
        ...
        for (auto set : setAndCount)
        {
            ...
            for (size_t i = 0; i < set.count_; ++i)
            {
                ...
                context_->setVkObjectname(descriptorSet,
    ...
    void Pipeline::bindDescriptorSets(VkCommandBuffer commandBuffer, const std::vector<SetAndBindingIndex>& sets)
    {
        for (const auto& set : sets)
        {
            vkCmdBindDescriptorSets(commandBuffer,
                                    ...
                                    set.set,
                                    1u,
                                    &descriptorSets_[set.set].vkSets_[set.bindIdx],
                                    0,
                                    nullptr);
        }
    }
    ...
    void Pipeline::updateBuffersDescriptorSets(uint32_t set,
                                               uint32_t index,
    ...
    void Pipeline::bindResource(uint32_t set,
                                uint32_t binding,
                                uint32_t index,
                                ...
                                VkFormat format)
    {
        bufferInfo_.emplace_back(std::vector<VkDescriptorBufferInfo>{
            VkDescriptorBufferInfo{.buffer = buffer->vkBuffer(), .offset = offset, .range = size}});
        ...
        const VkWriteDescriptorSet writeDescSet = {
            ...
            .pImageInfo = nullptr,
            .pBufferInfo =
                (type == VK_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER || type == VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER)
                    ? VK_NULL_HANDLE
                                ...
                                uint32_t dstArrayElement)
    {
        ...
        const VkWriteDescriptorSet writeDescSet = {
            ...
            .descriptorType = sampler ? VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER : VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE,
    ...
    void Pipeline::createGraphicsPipeline()
    {
        const VkSpecializationInfo vertexSpecializationInfo{
            .mapEntryCount = static_cast<uint32_t>(graphicsPipelineDesc_.vertexSpecConstants_.size()),
        ...
        const VkSpecializationInfo fragmentSpecializationInfo{
            .mapEntryCount = static_cast<uint32_t>(graphicsPipelineDesc_.fragmentSpecConstants_.size()),
        ...
        std::array<VkPipelineShaderStageCreateInfo, 2> shaderStages = {
            ...
            VkPipelineShaderStageCreateInfo{
                ...
                .pSpecializationInfo =
                    !graphicsPipelineDesc_.vertexSpecConstants_.empty() ? &vertexSpecializationInfo : nullptr,
            },
            VkPipelineShaderStageCreateInfo{
                .sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO,
                ...
                .pSpecializationInfo =
                    !graphicsPipelineDesc_.fragmentSpecConstants_.empty() ? &fragmentSpecializationInfo : nullptr,
            },
        };
        ...
        const VkGraphicsPipelineCreateInfo pipelineInfo = {
            ...
            .pNext = graphicsPipelineDesc_.useDynamicRendering_ ? &pipelineRenderingCreateInfo : nullptr,
        ...
        VK_CHECK(
            vkCreateGraphicsPipelines(context_->device(), VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &vkPipeline_));
    ...
    void Pipeline::createComputePipeline()
    {
        ...
        const VkSpecializationInfo specializationInfo{
            .mapEntryCount = static_cast<uint32_t>(computePipelineDesc_.specializationConsts_.size()),
        ...
        vkPipelineLayout_ = createPipelineLayout(descSetLayouts, computePipelineDesc_.pushConstants_);
        ...
        VK_CHECK(vkCreateComputePipelines(
            context_->device(), VK_NULL_HANDLE, 1, &computePipelineCreateInfo, VK_NULL_HANDLE, &vkPipeline_));
        context_->setVkObjectname(vkPipeline_, VK_OBJECT_TYPE_PIPELINE, "Compute pipeline: " + name_);
    }
    ...
    void Pipeline::createRayTracingPipeline()
    {
        ...
        vkPipelineLayout_ = createPipelineLayout(descSetLayouts, rayTracingPipelineDesc_.pushConstants_);
        ...
        VK_CHECK(vkCreateRayTracingPipelinesKHR(
            context_->device(), VK_NULL_HANDLE, VK_NULL_HANDLE, 1, &rayTracingPipelineInfo, nullptr, &vkPipeline_));

        context_->setVkObjectname(vkPipeline_, VK_OBJECT_TYPE_PIPELINE, "RayTracing pipeline: " + name_);
    }
    ...
    void Pipeline::initDescriptorPool()
    {
        ...
        context_->setVkObjectname(
            vkDescriptorPool_, VK_OBJECT_TYPE_DESCRIPTOR_POOL, "Graphics pipeline descriptor pool: " + name_);
    }
    ...
    void Pipeline::initDescriptorLayout()
    {
        ...
        for (size_t setIndex = 0; const auto& set : sets)
        {
            ...
            context_->setVkObjectname(descriptorSetLayout,
                                      VK_OBJECT_TYPE_DESCRIPTOR_SET_LAYOUT,
                                      "Graphics pipeline descriptor set " + std::to_string(setIndex++) +
                                          " layout: " + name_);
