...
namespace Huli::Vulkan
{
    ...
    void DynamicRendering::beginRenderingCmd(VkCommandBuffer commandBuffer,
                                             VkImage image,
                                             ...
                                             VkImageLayout newLayout)
    {
        ...
        {
            stencilRenderingAttachmentInfo = {.sType = VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_INFO,
                                              .pNext = NULL,
    ...
    void DynamicRendering::endRenderingCmd(VkCommandBuffer commandBuffer,
                                           VkImage image,
                                           VkImageLayout oldLayout,
                                           VkImageLayout newLayout)
    {
