...
namespace Huli::Render
{
    ...
    std::array<glm::vec4, 6> Camera::calculateFrustumPlanes()
    {
        ...
        const glm::vec3 nearTopRight = nearCameraPosition + nearPlaneHalfWidthVec + nearPlaneHalfHeightVec;
        const glm::vec3 nearBottomRight = nearCameraPosition + nearPlaneHalfWidthVec - nearPlaneHalfHeightVec;
        const glm::vec3 nearTopLeft = nearCameraPosition - nearPlaneHalfWidthVec + nearPlaneHalfHeightVec;
        const glm::vec3 nearBottomLeft = nearCameraPosition - nearPlaneHalfWidthVec - nearPlaneHalfHeightVec;

        const glm::vec3 farTopRight = farCameraPosition + farPlaneHalfWidthVec + farPlaneHalfHeightVec;
        const glm::vec3 farBottomRight = farCameraPosition + farPlaneHalfWidthVec - farPlaneHalfHeightVec;
        const glm::vec3 farTopLeft = farCameraPosition - farPlaneHalfWidthVec + farPlaneHalfHeightVec;
        const glm::vec3 farBottomLeft = farCameraPosition - farPlaneHalfWidthVec - farPlaneHalfHeightVec;

        auto getNormal = [](const glm::vec3& corner, const glm::vec3& point1, const glm::vec3& point2)
        {
    ...
    {
        const glm::quat deltaQuat = glm::quat(glm::vec3(-deltaT * delta.y, deltaT * delta.x, 0.0f));
